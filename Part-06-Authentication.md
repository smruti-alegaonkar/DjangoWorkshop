...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(next_page='leaves:home'), name='logout'),
        ...
        if form.is_valid():
            ...
            for leave_type in leave_types:
                LeaveBalance.objects.create(
                    ...
                    year=current_year,
                    total_leaves=leave_type.max_days_per_year,
                    used_leaves=0
                )
...
def profile(request):
    ...
    if request.method == 'POST':
        from .forms import FacultyProfileUpdateForm
        form = FacultyProfileUpdateForm(request.POST, request.FILES, instance=faculty)
        if form.is_valid():
            # Update user fields
            user = request.user
        ...
        from .forms import FacultyProfileUpdateForm
        form = FacultyProfileUpdateForm(instance=faculty)
...
{% block title %}Register - Leave Management{% endblock %}
    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="bi bi-person-plus"></i> Faculty Registration</h4>
            </div>
            <div class="card-body p-4">
